...
try {
    ...
    $protected = git diff $Baseline -- Dsp Audio Models Program.cs Persistence/SceneStore.cs Persistence/PresetStore.cs Persistence/AudioSettingsStore.cs Persistence/DualGuitarBankStore.cs Persistence/DualGuitarSceneStore.cs
    ...
    Copy-Item (Join-Path $PSScriptRoot 'CleanBankRegression.cs.txt') (Join-Path $work 'Program.cs') -Force
